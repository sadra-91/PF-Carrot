        ...
        for i in readyprompts:
            ...
            promptb.bind(
                ...
                setattr(
                    instance,
                    "text_size",
                    (instance.width-40,instance.height)
                )
            )

            promptb.bind(
                on_press=lambda instance,txt=i:chosepro(txt)
            )
        ...
        def showchat(chatid,instance):
            ...
            for i in range(0,messcount):
                ...
                if i%2==0:
                    ...
                    messagebubble.bind(
                        on_ref_press=partial(refpress,texttt)
                    )
